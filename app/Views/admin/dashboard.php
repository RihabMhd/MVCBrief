            ...
            <div class="navbar-right">
                <div class="user-info">
                    <div class="user-avatar">
                        <?php echo strtoupper(substr($data['current_user']['name'], 0, 1)); ?>
                    </div>
                    <span class="user-name"><?php echo htmlspecialchars($data['current_user']['name']); ?></span>
                </div>
        ...
        <div class="dashboard-grid">
            <div class="card">
                ...
                <div>
                    <div class="info-row">
                        ...
                        <div class="info-value"><?php echo htmlspecialchars($data['current_user']['name']); ?></div>
                    </div>
                    <div class="info-row">
                        <div class="info-label">Email Address</div>
                        <div class="info-value"><?php echo htmlspecialchars($data['current_user']['email']); ?></div>
                    </div>
                    <div class="info-row">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="card-subtitle">Platform statistics</p>
                </div>
                <div class="stats-grid">
                    ...
                    <div class="stat-card">
                        <div class="stat-value"><?php echo $data['total_roles']; ?></div>
            ...
            <div class="action-grid">
                ...
                <a href="/admin/roles" class="action-card">
                    ...
                    <div class="action-content">
                        ...
                        <div class="action-description">Configure user permissions</div>
                    </div>
                </a>
                <a href="/change-password" class="action-card">
                    ...
                    <div class="action-content">
                        ...
                        <div class="action-description">Update security credentials</div>
                    </div>
                </a>
            </div>
        </div>
